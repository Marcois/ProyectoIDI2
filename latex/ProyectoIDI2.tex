...
El modelo híbrido evidenció que la combinación de descriptores forenses con embeddings de CNN mejora la capacidad de detección en escenarios donde las imágenes sintéticas imitan fielmente las distribuciones naturales. Esto confirma que las features manuales son útiles para reforzar la sensibilidad del sistema frente a irregularidades estadísticas y texturales.
...
\bibitem{Ojala1994}
Ojala T., Pietikäinen M., Harwood D. (1994).
Performance evaluation of texture measures with classification based on Kullback discrimination of distributions.
\textit{Proceedings of the 12th IAPR International Conference on Pattern Recognition (ICPR 1994)}, vol. 1, pp. 582–585.
...
\bibitem{MartinRodriguez2023}
Martín-Rodríguez F., García-Mojón R., Fernández-Barciela M. (2023).
Detection of AI-Created Images Using Pixel-Wise Feature Extraction and Convolutional Neural Networks.
\textit{Sensors}, 23(22): 9037.
\url{https://pmc.ncbi.nlm.nih.gov/articles/PMC10674908/}

\bibitem{ScikitImage2023}
van der Walt, S., Schönberger, J. L., Nunez-Iglesias, J., Boulogne, F., Warner, J. D., Yang, Z. (2023).
scikit-image: Image processing in Python.
\textit{scikit-image documentation}.
